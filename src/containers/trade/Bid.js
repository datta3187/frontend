...
import {submitOrder} from '../../redux/actions/trade';
 ...
 class connectedBidLimit extends Component{
    constructor(props){
        ...
        this.state = {
            fields: { price: '', volume: '', market: this.props.market, side: 'buy', ord_type: 'limit'}
        };
    ...
    componentWillReceiveProps(nextProps, nextContext) {
        if(nextProps.orderStatus){
            this.setState({fields: { price: '', volume: '', market: this.props.market, side: 'buy', ord_type: 'limit'} } );
        }
    }
...
class connectedBidMarket extends Component {
    constructor(props){
        ...
        this.state = {
            fields: { volume: '', market: this.props.market, side: 'buy', ord_type: 'market'}
        };
    ...
    componentWillReceiveProps(nextProps) {
        if(nextProps.orderStatus){
            this.setState({fields: { volume: '', market: this.props.market, side: 'buy', ord_type: 'market'} } );
        }
    }
...
export const BidMarket = connect(mapStateToProps, mapDispatchToProps)(connectedBidMarket);
