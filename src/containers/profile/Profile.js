...
export class Profile extends Component {
    ...
    handleChangeDate = (event, { name, value }) => {
        ...
        this.setState(prevState => {
            ...
            fields.date = value;                     // update the name property, assign a new value                 
                        ...
                        <div className="kycWithThreeFields">
                            ...
                            <Form.Field>
                                ...
                                <Input type="text"
                                    ...
                                    onKeyUp={this.handleSignupKeyup.bind(this, "middleName")}
                        ...
                        <div className="kycWithThreeFields">
                            <Form.Field>
                                ...
                                <Select placeholder='country'
                                    ...
                                    onChange={this.setFormValue.bind(this, "country")}
                                    onKeyUp={this.handleSignupKeyup.bind(this, "country")} />
                                <span style={{ color: "red" }}>
                                    {this.state.errors["email"]}
                                </span>
                            </Form.Field>
                            <Form.Field>
                                ...
                                <Select placeholder='City'
                                    ...
                                    onKeyUp={this.handleSignupKeyup.bind(this, "city")} />
                                <span style={{ color: "red" }}>
                                    {this.state.errors["password"]}
                                </span>
                            </Form.Field>
                            <Form.Field>
                                ...
                                <Input type="text"
                                    onChange={this.setFormValue.bind(this, "postalCode")}
                                    onKeyUp={this.handleSignupKeyup.bind(this, "postalCode")}
                                    placeholder='Last Name' />
                                <span style={{ color: "red" }}>
                                    {this.state.errors["conPassword"]}
                                </span>
                        ...
                        <div className="kycWithThreeFields">
                            <Form.Field>
                                ...
                                <Input type="text"
                                    ...
                                    onKeyUp={this.handleSignupKeyup.bind(this, "phoneNumber")}
                            ...
                            <Form.Field>
                                ...
                                <Select placeholder='City'
                                    ...
                                    onKeyUp={this.handleSignupKeyup.bind(this, "documentType")} />
                                <span style={{ color: "red" }}>
                                    {this.state.errors["password"]}
                                </span>
                            </Form.Field>
                            <Form.Field>
                                ...
                                <Input type="text"
                                    ...
                                    onKeyUp={this.handleSignupKeyup.bind(this, "documentNumber")}
                        ...
                        <div className="kycWithThreeFields">
                            <Form.Field>
                                ...
                                <Input type="text"
                                    ...
                                    onKeyUp={this.handleSignupKeyup.bind(this, "expiryDate")}
                                    iconPosition='left'
